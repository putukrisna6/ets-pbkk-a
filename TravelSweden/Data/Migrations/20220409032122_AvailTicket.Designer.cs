...
namespace TravelSweden.Data.Migrations
{
    ...
    [Migration("20220409032122_AvailTicket")]
    partial class AvailTicket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelSweden.Models.Airport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelSweden.Models.FlightRoute", b =>
                {
                    b.HasOne("TravelSweden.Models.Airport", "DestAirport")
                        .WithMany()
                        .HasForeignKey("DestAirportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelSweden.Models.Airport", "OriginAirport")
                        .WithMany()

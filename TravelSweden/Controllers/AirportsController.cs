...
namespace TravelSweden.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Iata,Name,City")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Iata,Name,City")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
